...
const swapInstructions = [
    ...
    borsh_1.struct([borsh_1.vec(borsh_1.u64(), 'depositAmounts'), borsh_1.u64('minMintAmount')], 'addLiquidity'),
    borsh_1.struct([borsh_1.u64('unmintAmount'), borsh_1.vec(borsh_1.u64(), 'minimumAmounts')], 'removeLiquidity'),
    borsh_1.struct([borsh_1.u64('unmintAmount'), borsh_1.u64('minimumOutAmount')], 'removeLiquidityOneToken'),
    borsh_1.struct([borsh_1.u64('inAmount'), borsh_1.u64('minimumOutAmount')], 'exchange'),
    borsh_1.struct([], 'getVirtualPrice')
];
exports.SwapInstructionLayout = borsh_1.rustEnum(swapInstructions);
